...
// void xorEncryptDecrypt(uint8_t* data, size_t length, uint8_t key) {
...
// int main() {
//     // Encryption key (should be shared between transmitter and receiver)
//     uint8_t key = 0xAB;
...
//         xorEncryptDecrypt(frame.data, frame.can_dlc, key);
